...
+ (instancetype)yy_modelWithDictionary:(NSDictionary *)dictionary { /// done
    if (!dictionary || dictionary == (id)kCFNull) return nil;
    if (![dictionary isKindOfClass:[NSDictionary class]]) return nil;
    
    Class cls = [self class];
    XZJSONClassDescriptor *modelMeta = [XZJSONClassDescriptor descriptorForClass:cls];
    if (modelMeta->_forwardsDecodeForClass) {
...
- (BOOL)yy_modelSetWithDictionary:(NSDictionary *)dic {
    ...
    XZJSONClassDescriptor *modelMeta = [XZJSONClassDescriptor descriptorForClass:object_getClass(self)];
...
- (id)yy_modelCopy{
    ...
    XZJSONClassDescriptor *modelMeta = [XZJSONClassDescriptor descriptorForClass:self.class];
